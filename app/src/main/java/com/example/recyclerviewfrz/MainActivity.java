...
public class MainActivity extends AppCompatActivity {
    ...
    String[] singers = {"Mike Posner","Lukas Graham","Zayn","Fifth Harmony","Zara Larsson & MNEK","The Chainsmokers","Justin Bieber","G-Eazy x Bebe Rexha","DNCE","Ariana Grande","Florida","Twenty one Pilots","Drake","DJ Snake","Meghan Trainor"};
    int[] pics = {
